...
public class DeleteAccountAlert : UIElement{
    ...
    void Start(){
        ...
        fieldTwo.onValueChanged.AddListener((param) => {
            OnInputFieldChange(param);
        });
    }
    ...
    public void sureTwoTap(){
        ...
        if (loginType == LoginType.Guest){
            if (!"Delete".Equals(str)){
                ...
                fieldTwo.GetComponent<Image>().sprite = Resources.Load("Images/border_red", typeof(Sprite)) as Sprite;
                inputError = true;
            } else{
